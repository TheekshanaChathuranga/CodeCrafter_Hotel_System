...
const MONGODB_URI =
  "mongodb+srv://theekshanacnb:12345@cluster1.bktryu2.mongodb.net/thelake?retryWrites=true&w=majority&appName=Cluster1";
...
async function testResetToken() {
  try {
    ...
    const users = await User.find(
      {},
      "email username resetPasswordToken resetPasswordExpires"
    ).limit(3);
