...
import { sendBookingApprovalEmail, sendBookingRejectionEmail } from '../config/emailConfig.js';
...
router.patch('/:id/approve', async (req, res) => {
  try {
    ...
    if (booking.user && booking.user.email) {
      ...
      try {
        await sendBookingApprovalEmail(booking.user.email, booking.fullName, bookingDetails);
      } catch (emailError) {
...
router.patch('/pool/:id/approve', async (req, res) => {
  try {
    ...
    if (booking.email) {
      ...
      try {
        await sendBookingApprovalEmail(booking.email, booking.name, bookingDetails);
      } catch (emailError) {
