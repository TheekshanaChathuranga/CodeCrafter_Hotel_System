    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="relative max-w-md mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#16A085]"
        />
      </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          {filteredBookings.map(booking => (
            <div
              ...
              className="grid grid-cols-12 p-4 border-t hover:bg-gray-50 items-center cursor-pointer group"
            >
              ...
              <div className="col-span-2 flex justify-end">
                ...
                <ChevronRight className="w-4 h-4 ml-2 text-gray-400 group-hover:text-[#16A085]" />
              </div>
            </div>
          ))}
        </div>
